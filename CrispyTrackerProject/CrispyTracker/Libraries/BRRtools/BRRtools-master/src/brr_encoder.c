...
void ADPCMBlockMash(const Sample PCM_data[16], bool is_loop_point, bool is_end_point)
{
	int smin, kmin;
...
Sample *resample(Sample *samples, size_t samples_length, size_t out_length, char type)
{
